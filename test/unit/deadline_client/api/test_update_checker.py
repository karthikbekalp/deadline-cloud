...
PLATFORM_INSTALLER_URLS = {
    "linux": f"{MANIFEST_BASE_URL}/latest/linux/DeadlineCloudSubmitter-linux-x64-installer.run",
    "macos": f"{MANIFEST_BASE_URL}/latest/macos/DeadlineCloudSubmitter-osx-installer.app.zip",
    "windows": f"{MANIFEST_BASE_URL}/latest/windows/DeadlineCloudSubmitter-windows-x64-installer.exe",
}
