    ...
    def _build_ui(self) -> None:
        ...
        if self.release_notes_url:
            ...
            self.release_notes_button.setStyleSheet(
                f"QPushButton {{ color: {_COLOR_ACCENT}; text-decoration: underline; border: none; background: transparent; padding: 0; text-align: left; }}"
        ...
        if self.download_url:
            ...
            self.download_button.setStyleSheet(
                f"QPushButton {{ background-color: {_COLOR_ACCENT}; color: white; padding: 3px 12px; }}"
            )
